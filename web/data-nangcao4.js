...
/* ═══════════ ĐỀ 1 — TÍNH NHANH & TÍNH HỢP LÍ ═══════════ */
{
  ...
  questions: [
    { sec: 'Tính nhanh', name: 'Câu 1', pts: 1, text: 'Tính nhanh: <b>25 × 4 × 7</b>', opts: o4('700', '175', '70', '7000'), ans: 'A', why: '25 × 4 = 100; 100 × 7 = 700.' },
    { sec: 'Tính nhanh', name: 'Câu 2', pts: 1, text: 'Tính nhanh: <b>125 × 8 × 9</b>', opts: o4('900', '9000', '1125', '90000'), ans: 'B', why: '125 × 8 = 1000; 1000 × 9 = 9000.' },
    { sec: 'Tính tổng', name: 'Câu 3', pts: 1, text: 'Tính: <b>1 + 2 + 3 + … + 10</b>', opts: o4('45', '50', '55', '100'), ans: 'C', why: 'Ghép cặp (1+10) + (2+9) + … = 5 cặp × 11 = 55.' },
    { sec: 'Tính nhanh', name: 'Câu 4', pts: 1, text: 'Tính nhanh: <b>4 × 27 × 25</b>', opts: o4('270', '2727', '27000', '2700'), ans: 'D', why: '4 × 25 = 100; 100 × 27 = 2700.' },
    ...
    { sec: 'Tính nhanh', name: 'Câu 7', pts: 1, text: 'Tính nhanh: <b>137 × 99</b>', opts: o4('13700', '13437', '13563', '13653'), ans: 'C', why: '137 × 99 = 137 × 100 − 137 = 13700 − 137 = 13563.' },
    { sec: 'Tính tổng', name: 'Câu 8', pts: 1, text: 'Tính nhanh: <b>1998 + 1999 + 2000 + 2001 + 2002</b>', opts: o4('9990', '10010', '8000', '10000'), ans: 'D', why: 'Số ở giữa là 2000; tổng = 2000 × 5 = 10000.' },
    { sec: 'Nhân 11', name: 'Câu 9', pts: 1, text: 'Tính nhanh: <b>45 × 11</b>', opts: o4('495', '450', '405', '545'), ans: 'A', why: '45 × 11 = 45 × 10 + 45 = 450 + 45 = 495.' },
    { sec: 'Tính hợp lí', name: 'Câu 10', pts: 1, text: 'Tính nhanh: <b>64 × 25</b>', opts: o4('160', '1600', '1560', '16000'), ans: 'B', why: '64 × 25 = 16 × 4 × 25 = 16 × 100 = 1600.' },
  ],
},
...
/* ═══════════ ĐỀ 7 — ĐẾM HÌNH & ĐẾM SỐ ═══════════ */
{
  ...
  questions: [
    ...
    { sec: 'Đếm số', name: 'Câu 2', pts: 1, text: 'Có tất cả bao nhiêu số có <b>ba</b> chữ số?', opts: o4('899', '900', '999', '1000'), ans: 'B', why: 'Từ 100 đến 999 có 999 − 100 + 1 = 900 số.' },
...
/* ═══════════ ĐỀ 8 — CHỮ SỐ & CẤU TẠO SỐ ═══════════ */
{
  ...
  questions: [
    { sec: 'Cấu tạo số', name: 'Câu 1', pts: 1, text: 'Số có ba chữ số với hàng trăm là 5, hàng chục là 0, hàng đơn vị là 7 là số nào?', opts: o4('570', '5007', '507', '75'), ans: 'C', why: '5 trăm, 0 chục, 7 đơn vị viết là 507.' },
    { sec: 'Tổng chữ số', name: 'Câu 2', pts: 1, text: 'Tổng các chữ số của số 2358 là bao nhiêu?', opts: o4('8', '15', '20', '18'), ans: 'D', why: '2 + 3 + 5 + 8 = 18.' },
    ...
    { sec: 'Đếm chữ số', name: 'Câu 9', pts: 1, text: 'Trong số 2024, chữ số 2 xuất hiện mấy lần?', opts: o4('1', '3', '2', '4'), ans: 'C', why: 'Số 2024 có hai chữ số 2 (hàng nghìn và hàng chục).' },
...
/* ═══════════ ĐỀ 10 — HÌNH HỌC & TOÁN CÓ LỜI VĂN NHIỀU BƯỚC ═══════════ */
{
  ...
  questions: [
    ...
    { sec: 'Bài toán nhiều bước', name: 'Câu 6', pts: 1, text: 'Một mảnh vườn hình chữ nhật dài 25 m, rộng 15 m. Mỗi mét vuông thu được 3 kg rau. Cả vườn thu được bao nhiêu ki-lô-gam rau?', opts: o4('375 kg', '750 kg', '40 kg', '1125 kg'), ans: 'D', why: 'Diện tích = 25 × 15 = 375 m²; số rau = 375 × 3 = 1125 (kg).' },
    ...
    { sec: 'Bài toán nhiều bước', name: 'Câu 10', pts: 1, text: 'Lan có 60000 đồng, mua 3 quyển vở giá 8000 đồng/quyển và 2 chiếc bút giá 5000 đồng/chiếc. Lan còn lại bao nhiêu tiền?', opts: o4('34000 đồng', '24000 đồng', '16000 đồng', '26000 đồng'), ans: 'D', why: 'Tiền vở = 3 × 8000 = 24000; tiền bút = 2 × 5000 = 10000; còn lại = 60000 − 34000 = 26000 (đồng).' },
  ],
},
