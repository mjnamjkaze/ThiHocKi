...
/* ═══════════ ĐỀ 4 — TỈ SỐ PHẦN TRĂM ═══════════ */
{
  ...
  questions: [
    ...
    { sec: 'Bài toán', name: 'Câu 8', pts: 1, text: 'Một chiếc áo giá 200000 đồng, giảm 10%. Số tiền được giảm là:', opts: o4('20000 đồng', '10000 đồng', '2000 đồng', '180000 đồng'), ans: 'A', why: '10% của 200000 = 20000 (đồng).' },
...
/* ═══════════ ĐỀ 5 — ĐƠN VỊ ĐO DIỆN TÍCH, THỂ TÍCH ═══════════ */
{
  ...
  questions: [
    { sec: 'Diện tích', name: 'Câu 1', pts: 1, text: '1 ha = ? m²', opts: o4('10000 m²', '1000 m²', '100 m²', '100000 m²'), ans: 'A', why: '1 héc-ta (ha) = 10000 m².' },
    { sec: 'Diện tích', name: 'Câu 2', pts: 1, text: '1 km² = ? ha', opts: o4('100 ha', '10 ha', '1000 ha', '1 ha'), ans: 'A', why: '1 km² = 100 ha.' },
    { sec: 'Diện tích', name: 'Câu 3', pts: 1, text: '1 m² = ? cm²', opts: o4('10000 cm²', '100 cm²', '1000 cm²', '1000000 cm²'), ans: 'A', why: '1 m² = 10000 cm².' },
    { sec: 'Thể tích', name: 'Câu 4', pts: 1, text: '1 dm³ = ? cm³', opts: o4('1000 cm³', '100 cm³', '10 cm³', '10000 cm³'), ans: 'A', why: '1 dm³ = 1000 cm³.' },
    { sec: 'Thể tích', name: 'Câu 5', pts: 1, text: '1 m³ = ? dm³', opts: o4('1000 dm³', '100 dm³', '10 dm³', '1000000 dm³'), ans: 'A', why: '1 m³ = 1000 dm³.' },
    { sec: 'Diện tích', name: 'Câu 6', pts: 1, text: '5 m² = ? dm²', opts: o4('500 dm²', '50 dm²', '5000 dm²', '5 dm²'), ans: 'A', why: '1 m² = 100 dm² nên 5 m² = 500 dm².' },
    { sec: 'Thể tích', name: 'Câu 7', pts: 1, text: '1 lít = ? dm³', opts: o4('1 dm³', '10 dm³', '100 dm³', '1000 dm³'), ans: 'A', why: '1 lít = 1 dm³.' },
    { sec: 'Diện tích', name: 'Câu 8', pts: 1, text: '2 ha = ? m²', opts: o4('20000 m²', '2000 m²', '200 m²', '200000 m²'), ans: 'A', why: '2 × 10000 = 20000 m².' },
    { sec: 'Thể tích', name: 'Câu 9', pts: 1, text: '1 m³ = ? lít', opts: o4('1000 lít', '100 lít', '10 lít', '1 lít'), ans: 'A', why: '1 m³ = 1000 dm³ = 1000 lít.' },
    { sec: 'Thể tích', name: 'Câu 10', pts: 1, text: '3 dm³ = ? cm³', opts: o4('3000 cm³', '300 cm³', '30 cm³', '30000 cm³'), ans: 'A', why: '3 × 1000 = 3000 cm³.' },
  ],
},
...
/* ═══════════ ĐỀ 10 — ÔN TẬP TỔNG HỢP ═══════════ */
{
  ...
  questions: [
    ...
    { sec: 'Đơn vị', name: 'Câu 4', pts: 1, text: '1 ha = ? m²', opts: o4('10000 m²', '1000 m²', '100 m²', '100000 m²'), ans: 'A', why: '1 ha = 10000 m².' },
...
/* ═══════════ ĐỀ 16 — TỈ SỐ PHẦN TRĂM (BÀI TOÁN) ═══════════ */
{
  ...
  questions: [
    { sec: 'Giảm giá', name: 'Câu 1', pts: 1, text: 'Áo giá 300000 đồng, giảm 20%. Số tiền được giảm là:', opts: o4('60000 đồng', '30000 đồng', '20000 đồng', '240000 đồng'), ans: 'A', why: '300000 × 20 : 100 = 60000 (đồng).' },
    { sec: 'Giảm giá', name: 'Câu 2', pts: 1, text: 'Áo giá 300000 đồng, giảm 20%. Giá sau khi giảm là:', opts: o4('240000 đồng', '60000 đồng', '280000 đồng', '250000 đồng'), ans: 'A', why: '300000 − 60000 = 240000 (đồng).' },
    { sec: 'Lãi suất', name: 'Câu 3', pts: 1, text: 'Gửi 1000000 đồng lãi 6% một năm. Sau một năm được lãi:', opts: o4('60000 đồng', '6000 đồng', '600000 đồng', '66000 đồng'), ans: 'A', why: '1000000 × 6 : 100 = 60000 (đồng).' },
    ...
    { sec: 'Lãi bán hàng', name: 'Câu 10', pts: 1, text: 'Vốn 400000 đồng, bán lãi 25% so với vốn. Giá bán là:', opts: o4('500000 đồng', '425000 đồng', '480000 đồng', '300000 đồng'), ans: 'A', why: 'Lãi = 400000 × 25 : 100 = 100000; giá bán = 400000 + 100000 = 500000 (đồng).' },
  ],
},
...
/* ═══════════ ĐỀ 21 — HÌNH LẬP PHƯƠNG ═══════════ */
{
  ...
  questions: [
    ...
    { sec: 'Thể tích', name: 'Câu 7', pts: 1, text: 'Hình lập phương cạnh 10 cm có thể tích là:', opts: o4('1000 cm³', '100 cm³', '30 cm³', '300 cm³'), ans: 'A', why: 'V = 10 × 10 × 10 = 1000 (cm³).' },
...
/* ═══════════ ĐỀ 22 — ĐƠN VỊ ĐO DIỆN TÍCH, THỂ TÍCH ═══════════ */
{
  ...
  questions: [
    { sec: 'Diện tích', name: 'Câu 1', pts: 1, text: '1 ha = ? m²', opts: o4('10000 m²', '1000 m²', '100 m²', '100000 m²'), ans: 'A', why: '1 ha = 10000 m².' },
    { sec: 'Diện tích', name: 'Câu 2', pts: 1, text: '2,5 km² = ? ha', opts: o4('25 ha', '250 ha', '2500 ha', '2,5 ha'), ans: 'B', why: '1 km² = 100 ha nên 2,5 km² = 250 ha.' },
    { sec: 'Diện tích', name: 'Câu 3', pts: 1, text: '3 m² 5 dm² = ? dm²', opts: o4('305 dm²', '35 dm²', '350 dm²', '3,5 dm²'), ans: 'A', why: '3 m² = 300 dm²; 300 + 5 = 305 (dm²).' },
    { sec: 'Thể tích', name: 'Câu 4', pts: 1, text: '1 m³ = ? cm³', opts: o4('1000 cm³', '10000 cm³', '1000000 cm³', '100 cm³'), ans: 'C', why: '1 m³ = 1000 dm³ = 1000000 cm³.' },
    { sec: 'Thể tích', name: 'Câu 5', pts: 1, text: '4,5 dm³ = ? cm³', opts: o4('4500 cm³', '450 cm³', '45 cm³', '45000 cm³'), ans: 'A', why: '1 dm³ = 1000 cm³ nên 4,5 dm³ = 4500 cm³.' },
    { sec: 'Diện tích', name: 'Câu 6', pts: 1, text: '7000 m² = ? ha', opts: o4('7 ha', '70 ha', '0,07 ha', '0,7 ha'), ans: 'D', why: '1 ha = 10000 m² nên 7000 m² = 0,7 ha.' },
    { sec: 'Thể tích', name: 'Câu 7', pts: 1, text: '2 m³ 50 dm³ = ? dm³', opts: o4('2050 dm³', '250 dm³', '2500 dm³', '2005 dm³'), ans: 'A', why: '2 m³ = 2000 dm³; 2000 + 50 = 2050 (dm³).' },
    { sec: 'Diện tích', name: 'Câu 8', pts: 1, text: '500 cm² = ? dm²', opts: o4('5 dm²', '50 dm²', '0,5 dm²', '500 dm²'), ans: 'A', why: '1 dm² = 100 cm² nên 500 cm² = 5 dm².' },
    { sec: 'Thể tích', name: 'Câu 9', pts: 1, text: '6 m³ = ? lít', opts: o4('600 lít', '6000 lít', '60 lít', '6 lít'), ans: 'B', why: '1 m³ = 1000 lít nên 6 m³ = 6000 lít.' },
    { sec: 'Diện tích', name: 'Câu 10', pts: 1, text: '8 ha = ? m²', opts: o4('80000 m²', '8000 m²', '800000 m²', '800 m²'), ans: 'A', why: '8 × 10000 = 80000 (m²).' },
  ],
},
...
/* ═══════════ ĐỀ 23 — VẬN TỐC, QUÃNG ĐƯỜNG, THỜI GIAN ═══════════ */
{
  ...
  questions: [
    ...
    { sec: 'Quãng đường', name: 'Câu 8', pts: 1, text: 'Máy bay 800 km/giờ bay 2 giờ, quãng đường là:', opts: o4('1600 km', '400 km', '802 km', '1000 km'), ans: 'A', why: 's = 800 × 2 = 1600 (km).' },
...
/* ═══════════ ĐỀ 26 — BÀI TOÁN CÓ LỜI VĂN ═══════════ */
{
  ...
  questions: [
    { sec: 'Mua bán', name: 'Câu 1', pts: 1, text: 'Mua 3 kg táo giá 25000 đồng một ki-lô-gam. Số tiền phải trả là:', opts: o4('75000 đồng', '28000 đồng', '22000 đồng', '75 kg'), ans: 'A', why: '3 × 25000 = 75000 (đồng).' },
    { sec: 'Mua bán', name: 'Câu 2', pts: 1, text: '5 quyển vở giá 60000 đồng. Một quyển giá:', opts: o4('12000 đồng', '65000 đồng', '300000 đồng', '55000 đồng'), ans: 'A', why: '60000 : 5 = 12000 (đồng).' },
    ...
    { sec: 'Bù đủ', name: 'Câu 9', pts: 1, text: 'Bể chứa 1000 lít đã có 350 lít. Cần thêm bao nhiêu lít cho đầy?', opts: o4('650 lít', '1350 lít', '700 lít', '450 lít'), ans: 'A', why: '1000 − 350 = 650 (lít).' },
...
/* ═══════════ ĐỀ 27 — ÔN TẬP TỔNG HỢP (1) ═══════════ */
{
  ...
  questions: [
    ...
    { sec: 'Đơn vị', name: 'Câu 6', pts: 1, text: '1 km² = ? ha', opts: o4('100 ha', '10 ha', '1000 ha', '1 ha'), ans: 'A', why: '1 km² = 100 ha.' },
...
/* ═══════════ ĐỀ 28 — ÔN TẬP TỔNG HỢP (2) ═══════════ */
{
  ...
  questions: [
    ...
    { sec: 'Đơn vị', name: 'Câu 6', pts: 1, text: '3 dm³ = ? cm³', opts: o4('3000 cm³', '300 cm³', '30 cm³', '30000 cm³'), ans: 'A', why: '1 dm³ = 1000 cm³ nên 3 dm³ = 3000 cm³.' },
...
/* ═══════════ ĐỀ 30 — ÔN TẬP CUỐI NĂM — HSG ═══════════ */
{
  ...
  questions: [
    ...
    { sec: 'Tính nhanh', name: 'Câu 2', pts: 1, text: '2,5 × 4 × 10 = ?', opts: o4('10', '100', '1000', '25'), ans: 'B', why: '2,5 × 4 = 10; 10 × 10 = 100.' },
    ...
    { sec: 'Đổi đơn vị', name: 'Câu 5', pts: 1, text: 'Bể trên chứa đầy nước thì được bao nhiêu lít?', opts: o4('9000 lít', '900 lít', '90 lít', '9 lít'), ans: 'A', why: '9 m³ = 9000 dm³ = 9000 lít.' },
    ...
    { sec: 'Lãi suất', name: 'Câu 9', pts: 1, text: 'Lãi suất 0,5% một tháng, gửi 2000000 đồng. Lãi một tháng là:', opts: o4('100000 đồng', '10000 đồng', '1000 đồng', '20000 đồng'), ans: 'B', why: '2000000 × 0,5 : 100 = 10000 (đồng).' },
