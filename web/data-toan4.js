...
/* ═══════════ ĐỀ 1 — SỐ TỰ NHIÊN ĐẾN LỚP TRIỆU ═══════════ */
{
  ...
  questions: [
    { sec: 'Cấu tạo số', name: 'Câu 1', pts: 1, text: 'Số 1000000 (một triệu) có mấy chữ số 0?', opts: o4('5', '6', '7', '4'), ans: 'B', why: '1000000 gồm chữ số 1 và 6 chữ số 0.' },
    { sec: 'Đọc số', name: 'Câu 2', pts: 1, text: 'Số 305720 đọc là:', opts: o4('Ba trăm linh năm nghìn bảy trăm hai mươi', 'Ba trăm năm nghìn bảy trăm hai mươi', 'Ba mươi lăm nghìn bảy trăm hai mươi', 'Ba trăm linh năm nghìn bảy trăm hai'), ans: 'A', why: '305720 đọc là "ba trăm linh năm nghìn bảy trăm hai mươi".' },
    { sec: 'Giá trị chữ số', name: 'Câu 3', pts: 1, text: 'Giá trị của chữ số 7 trong số 27483 là bao nhiêu?', opts: o4('7', '70', '700', '7000'), ans: 'D', why: 'Chữ số 7 ở hàng nghìn nên có giá trị 7000.' },
    { sec: 'Số lớn nhất', name: 'Câu 4', pts: 1, text: 'Số lớn nhất có 5 chữ số là số nào?', opts: o4('99999', '10000', '90000', '99990'), ans: 'A', why: 'Số lớn nhất có 5 chữ số là 99999.' },
    { sec: 'Số bé nhất', name: 'Câu 5', pts: 1, text: 'Số bé nhất có 6 chữ số là số nào?', opts: o4('999999', '100000', '111111', '100001'), ans: 'B', why: 'Số bé nhất có 6 chữ số là 100000.' },
    { sec: 'Làm tròn', name: 'Câu 6', pts: 1, text: 'Làm tròn số 45678 đến hàng nghìn được số nào?', opts: o4('45000', '46000', '45700', '40000'), ans: 'B', why: 'Chữ số hàng trăm là 6 (≥ 5) nên làm tròn lên: 46000.' },
    { sec: 'Hàng', name: 'Câu 7', pts: 1, text: 'Trong số 8216400, chữ số 2 thuộc hàng nào?', opts: o4('Hàng trăm nghìn', 'Hàng chục nghìn', 'Hàng nghìn', 'Hàng trăm'), ans: 'A', why: 'Từ phải sang: 8(triệu) 2(trăm nghìn) 1(chục nghìn) 6(nghìn)... nên 2 ở hàng trăm nghìn.' },
    { sec: 'So sánh', name: 'Câu 8', pts: 1, text: 'Điền dấu thích hợp: 65432 ... 65342', opts: o4('>', '<', '=', 'Không so sánh được'), ans: 'A', why: 'Cùng hàng nghìn, so hàng trăm: 4 > 3 nên 65432 > 65342.' },
    { sec: 'Số liền sau', name: 'Câu 9', pts: 1, text: 'Số liền sau của 99999 là số nào?', opts: o4('99998', '100000', '90000', '99990'), ans: 'B', why: 'Liền sau 99999 là 100000.' },
    { sec: 'Viết số', name: 'Câu 10', pts: 1, text: '"Hai mươi ba nghìn không trăm bốn mươi" viết là số nào?', opts: o4('23040', '23400', '23004', '203040'), ans: 'A', why: '23 nghìn, 0 trăm, 40 đơn vị viết là 23040.' },
  ],
},
...
/* ═══════════ ĐỀ 2 — BỐN PHÉP TÍNH ═══════════ */
{
  ...
  questions: [
    { sec: 'Cộng', name: 'Câu 1', pts: 1, text: '3456 + 2178 = ?', opts: o4('5634', '5624', '5534', '5734'), ans: 'A', why: '3456 + 2178 = 5634.' },
    { sec: 'Trừ', name: 'Câu 2', pts: 1, text: '7000 − 2345 = ?', opts: o4('4655', '4755', '5655', '4645'), ans: 'A', why: '7000 − 2345 = 4655.' },
    { sec: 'Nhân', name: 'Câu 3', pts: 1, text: '234 × 3 = ?', opts: o4('702', '692', '712', '602'), ans: 'A', why: '234 × 3 = 702.' },
    { sec: 'Nhân', name: 'Câu 4', pts: 1, text: '125 × 8 = ?', opts: o4('1000', '1025', '960', '1080'), ans: 'A', why: '125 × 8 = 1000.' },
    { sec: 'Chia', name: 'Câu 5', pts: 1, text: '4848 : 4 = ?', opts: o4('1212', '1202', '1221', '1122'), ans: 'A', why: '4848 : 4 = 1212.' },
    { sec: 'Nhân 10', name: 'Câu 6', pts: 1, text: '246 × 10 = ?', opts: o4('2460', '246', '24600', '2406'), ans: 'A', why: 'Nhân với 10 thì thêm một chữ số 0: 2460.' },
    ...
    { sec: 'Chia 100', name: 'Câu 10', pts: 1, text: '9000 : 100 = ?', opts: o4('90', '900', '9', '9000'), ans: 'A', why: 'Chia cho 100 thì bớt hai chữ số 0: 90.' },
  ],
},
...
/* ═══════════ ĐỀ 9 — ĐƠN VỊ ĐO VÀ GÓC ═══════════ */
{
  ...
  questions: [
    { sec: 'Khối lượng', name: 'Câu 1', pts: 1, text: '1 tấn = ? kg', opts: o4('1000 kg', '100 kg', '10 kg', '10000 kg'), ans: 'A', why: '1 tấn = 1000 kg.' },
    { sec: 'Khối lượng', name: 'Câu 2', pts: 1, text: '1 tạ = ? kg', opts: o4('100 kg', '10 kg', '1000 kg', '50 kg'), ans: 'A', why: '1 tạ = 100 kg.' },
    { sec: 'Khối lượng', name: 'Câu 3', pts: 1, text: '5 kg = ? g', opts: o4('5000 g', '500 g', '50 g', '50000 g'), ans: 'A', why: '1 kg = 1000 g nên 5 kg = 5000 g.' },
    { sec: 'Thời gian', name: 'Câu 4', pts: 1, text: '1 giờ = ? phút', opts: o4('60', '100', '30', '24'), ans: 'A', why: '1 giờ = 60 phút.' },
    { sec: 'Thời gian', name: 'Câu 5', pts: 1, text: '1 thế kỉ = ? năm', opts: o4('100', '10', '1000', '50'), ans: 'A', why: '1 thế kỉ = 100 năm.' },
    { sec: 'Diện tích', name: 'Câu 6', pts: 1, text: '1 m² = ? dm²', opts: o4('100', '10', '1000', '1 00 00'), ans: 'A', why: '1 m² = 100 dm².' },
...
/* ═══════════ ĐỀ 11 — SỐ ĐẾN LỚP TRIỆU (NÂNG CAO) ═══════════ */
{
  ...
  questions: [
    { sec: 'Giá trị chữ số', name: 'Câu 1', pts: 1, text: 'Giá trị của chữ số 5 trong số 45672189 là bao nhiêu?', opts: o4('500000', '5000000', '50000', '5000'), ans: 'B', why: 'Từ phải sang: 5 đứng ở hàng triệu nên có giá trị 5000000.' },
    { sec: 'Đọc số', name: 'Câu 2', pts: 1, text: 'Số 7006020 đọc là:', opts: o4('Bảy triệu không trăm linh sáu nghìn không trăm hai mươi', 'Bảy triệu sáu nghìn hai mươi', 'Bảy triệu không trăm sáu mươi nghìn không trăm hai mươi', 'Bảy triệu không trăm linh sáu nghìn hai trăm'), ans: 'A', why: '7006020 gồm 7 triệu, 006 nghìn, 020 đơn vị → "bảy triệu không trăm linh sáu nghìn không trăm hai mươi".' },
    { sec: 'So sánh', name: 'Câu 3', pts: 1, text: 'Điền dấu thích hợp: 9999999 ... 10000000', opts: o4('>', '<', '=', 'Không so sánh được'), ans: 'B', why: '9999999 có 7 chữ số, 10000000 có 8 chữ số nên 9999999 < 10000000.' },
    { sec: 'Làm tròn', name: 'Câu 4', pts: 1, text: 'Làm tròn số 2547863 đến hàng trăm nghìn được số nào?', opts: o4('2600000', '2550000', '2500000', '2000000'), ans: 'C', why: 'Chữ số hàng chục nghìn là 4 (< 5) nên làm tròn xuống: 2500000.' },
    { sec: 'Số liền trước', name: 'Câu 5', pts: 1, text: 'Số liền trước của 1000000 là số nào?', opts: o4('1000001', '900000', '999000', '999999'), ans: 'D', why: 'Liền trước 1000000 là 999999.' },
    { sec: 'Viết số', name: 'Câu 6', pts: 1, text: '"Ba triệu hai trăm nghìn không trăm năm mươi" viết là số nào?', opts: o4('3200050', '3200500', '3020050', '3200005'), ans: 'A', why: '3 triệu, 200 nghìn, 050 đơn vị viết là 3200050.' },
    { sec: 'Số chẵn lớn nhất', name: 'Câu 7', pts: 1, text: 'Số chẵn lớn nhất có 6 chữ số là số nào?', opts: o4('1000000', '999999', '999998', '999990'), ans: 'C', why: 'Số lớn nhất có 6 chữ số là 999999 (lẻ), số chẵn lớn nhất là 999998.' },
    { sec: 'Đếm số', name: 'Câu 8', pts: 1, text: 'Có tất cả bao nhiêu số có ba chữ số?', opts: o4('999', '900', '1000', '899'), ans: 'B', why: 'Từ 100 đến 999 có 999 − 100 + 1 = 900 số.' },
    { sec: 'Cấu tạo số', name: 'Câu 9', pts: 1, text: 'Số 30517 có mấy chữ số?', opts: o4('4', '6', '3', '5'), ans: 'D', why: 'Các chữ số 3, 0, 5, 1, 7 — tất cả 5 chữ số.' },
    { sec: 'Hàng', name: 'Câu 10', pts: 1, text: 'Chữ số hàng triệu trong số 82456013 là chữ số nào?', opts: o4('2', '8', '4', '6'), ans: 'A', why: 'Từ phải sang: 8(chục triệu) 2(triệu)... nên chữ số hàng triệu là 2.' },
  ],
},
...
/* ═══════════ ĐỀ 12 — BỐN PHÉP TÍNH & TÍNH NHANH ═══════════ */
{
  ...
  questions: [
    { sec: 'Cộng', name: 'Câu 1', pts: 1, text: '12345 + 6789 = ?', opts: o4('19034', '19134', '18134', '19144'), ans: 'B', why: '12345 + 6789 = 19134.' },
    { sec: 'Trừ', name: 'Câu 2', pts: 1, text: '50000 − 23456 = ?', opts: o4('26544', '27544', '26644', '26454'), ans: 'A', why: '50000 − 23456 = 26544.' },
    { sec: 'Nhân', name: 'Câu 3', pts: 1, text: '1234 × 5 = ?', opts: o4('6150', '6270', '6170', '5170'), ans: 'C', why: '1234 × 5 = 6170.' },
    { sec: 'Chia', name: 'Câu 4', pts: 1, text: '3456 : 8 = ?', opts: o4('422', '438', '342', '432'), ans: 'D', why: '3456 : 8 = 432 (vì 432 × 8 = 3456).' },
    { sec: 'Tính nhanh', name: 'Câu 5', pts: 1, text: '25 × 4 × 7 = ?', opts: o4('700', '680', '70', '7000'), ans: 'A', why: '25 × 4 = 100, rồi 100 × 7 = 700.' },
    { sec: 'Tính nhanh', name: 'Câu 6', pts: 1, text: '4 × 125 × 2 = ?', opts: o4('8000', '1000', '100', '1250'), ans: 'B', why: '4 × 125 = 500, rồi 500 × 2 = 1000.' },
    { sec: 'Tính nhanh', name: 'Câu 7', pts: 1, text: '96 + 199 = ?', opts: o4('295', '305', '285', '296'), ans: 'A', why: '96 + 199 = 96 + 200 − 1 = 295.' },
    { sec: 'Tìm x', name: 'Câu 8', pts: 1, text: 'Tìm x, biết: x − 250 = 750', opts: o4('500', '1050', '1000', '900'), ans: 'C', why: 'x = 750 + 250 = 1000.' },
...
/* ═══════════ ĐỀ 17 — TÌM HAI SỐ (TỔNG – HIỆU) ═══════════ */
{
  ...
  questions: [
    ...
    { sec: 'Lời văn', name: 'Câu 10', pts: 1, text: 'Hai thửa ruộng thu 500 kg thóc, thửa 1 hơn thửa 2100 kg. Thửa 2 thu bao nhiêu ki-lô-gam?', opts: o4('200', '300', '250', '150'), ans: 'A', why: 'Thửa 2 = (500 − 100) : 2 = 400 : 2 = 200 (kg).' },
  ],
},
...
/* ═══════════ ĐỀ 19 — ĐƠN VỊ ĐO KHỐI LƯỢNG & THỜI GIAN ═══════════ */
{
  ...
  questions: [
    { sec: 'Khối lượng', name: 'Câu 1', pts: 1, text: '3 tấn 5 tạ = ? kg', opts: o4('3050 kg', '3500 kg', '3005 kg', '35000 kg'), ans: 'B', why: '3 tấn = 3000 kg, 5 tạ = 500 kg → 3500 kg.' },
    { sec: 'Khối lượng', name: 'Câu 2', pts: 1, text: '4 kg 200 g = ? g', opts: o4('4200 g', '4020 g', '420 g', '42000 g'), ans: 'A', why: '4 kg = 4000 g, cộng 200 g → 4200 g.' },
    ...
    { sec: 'Khối lượng', name: 'Câu 6', pts: 1, text: '5 tạ = ? kg', opts: o4('50', '500', '5000', '5'), ans: 'B', why: '1 tạ = 100 kg nên 5 tạ = 500 kg.' },
    { sec: 'Thời gian', name: 'Câu 7', pts: 1, text: '3 ngày = ? giờ', opts: o4('72', '36', '48', '24'), ans: 'A', why: '1 ngày = 24 giờ; 24 × 3 = 72 giờ.' },
    { sec: 'Khối lượng', name: 'Câu 8', pts: 1, text: '6000 kg = ? tấn', opts: o4('60', '600', '6', '6000'), ans: 'C', why: '1 tấn = 1000 kg nên 6000 kg = 6 tấn.' },
...
/* ═══════════ ĐỀ 20 — ĐƠN VỊ ĐO DIỆN TÍCH & GÓC ═══════════ */
{
  ...
  questions: [
    { sec: 'Diện tích', name: 'Câu 1', pts: 1, text: '1 m² = ? cm²', opts: o4('100', '10000', '1000', '100000'), ans: 'B', why: '1 m² = 100 dm² = 10000 cm².' },
    { sec: 'Diện tích', name: 'Câu 2', pts: 1, text: '5 m² = ? dm²', opts: o4('500', '50', '5000', '55'), ans: 'A', why: '1 m² = 100 dm² nên 5 m² = 500 dm².' },
    ...
    { sec: 'Diện tích', name: 'Câu 7', pts: 1, text: '2 m² 30 dm² = ? dm²', opts: o4('230', '2300', '203', '23'), ans: 'A', why: '2 m² = 200 dm², cộng 30 dm² → 230 dm².' },
...
/* ═══════════ ĐỀ 23 — BÀI TOÁN CÓ LỜI VĂN (1) ═══════════ */
{
  ...
  questions: [
    { sec: 'Lời văn', name: 'Câu 1', pts: 1, text: 'Cửa hàng có 1250 kg gạo, đã bán 480 kg. Cửa hàng còn lại bao nhiêu ki-lô-gam gạo?', opts: o4('870 kg', '770 kg', '730 kg', '1730 kg'), ans: 'B', why: '1250 − 480 = 770 (kg).' },
    ...
    { sec: 'Lời văn', name: 'Câu 4', pts: 1, text: 'Mua 3 kg táo hết 90000 đồng. Hỏi 1 kg táo giá bao nhiêu tiền?', opts: o4('30000 đồng', '27000 đồng', '60000 đồng', '93000 đồng'), ans: 'A', why: '90000 : 3 = 30000 (đồng).' },
    ...
    { sec: 'Lời văn', name: 'Câu 6', pts: 1, text: 'Thư viện có 1500 cuốn sách, mua thêm 350 cuốn. Hỏi thư viện có tất cả bao nhiêu cuốn?', opts: o4('1150', '1850', '1800', '1250'), ans: 'B', why: '1500 + 350 = 1850 (cuốn).' },
...
/* ═══════════ ĐỀ 24 — BÀI TOÁN CÓ LỜI VĂN (2) ═══════════ */
{
  ...
  questions: [
    ...
    { sec: 'Lời văn', name: 'Câu 4', pts: 1, text: 'Một bể chứa 2000 lít nước, đã dùng 3/5 lượng nước đó. Bể còn lại bao nhiêu lít?', opts: o4('800 lít', '1200 lít', '400 lít', '600 lít'), ans: 'A', why: 'Đã dùng = 2000 : 5 × 3 = 1200; còn lại = 2000 − 1200 = 800 (lít).' },
    { sec: 'Lời văn', name: 'Câu 5', pts: 1, text: 'Mua 5 quyển vở (mỗi quyển 8000 đồng) và 3 cây bút (mỗi cây 5000 đồng). Hết tất cả bao nhiêu tiền?', opts: o4('65000 đồng', '40000 đồng', '13000 đồng', '55000 đồng'), ans: 'D', why: 'Vở: 5 × 8000 = 40000; bút: 3 × 5000 = 15000; tổng = 55000 (đồng).' },
    { sec: 'Lời văn', name: 'Câu 6', pts: 1, text: 'Một đội trồng 1200 cây trong 4 ngày, mỗi ngày trồng như nhau. Trong 3 ngày đội trồng được bao nhiêu cây?', opts: o4('300', '900', '1200', '600'), ans: 'B', why: 'Mỗi ngày = 1200 : 4 = 300; ba ngày = 300 × 3 = 900 (cây).' },
    { sec: 'Lời văn', name: 'Câu 7', pts: 1, text: 'Trung bình mỗi bao gạo nặng 50 kg. Hỏi 24 bao gạo nặng bao nhiêu ki-lô-gam?', opts: o4('1200 kg', '74 kg', '600 kg', '1250 kg'), ans: 'A', why: '50 × 24 = 1200 (kg).' },
...
/* ═══════════ ĐỀ 25 — ÔN TẬP TỔNG HỢP (1) ═══════════ */
{
  ...
  questions: [
    { sec: 'Đọc số', name: 'Câu 1', pts: 1, text: 'Số 60000000 đọc là:', opts: o4('Sáu triệu', 'Sáu mươi triệu', 'Sáu trăm triệu', 'Sáu mươi nghìn'), ans: 'B', why: '60000000 đọc là "sáu mươi triệu".' },
    { sec: 'Cộng', name: 'Câu 2', pts: 1, text: '25000 + 17000 = ?', opts: o4('42000', '32000', '43000', '41000'), ans: 'A', why: '25000 + 17000 = 42000.' },
    ...
    { sec: 'Đơn vị đo', name: 'Câu 7', pts: 1, text: '3 tấn = ? kg', opts: o4('3000', '300', '30000', '30'), ans: 'A', why: '1 tấn = 1000 kg nên 3 tấn = 3000 kg.' },
...
/* ═══════════ ĐỀ 26 — ÔN TẬP TỔNG HỢP (2) ═══════════ */
{
  ...
  questions: [
    { sec: 'Giá trị chữ số', name: 'Câu 1', pts: 1, text: 'Giá trị của chữ số 6 trong số 3604200 là bao nhiêu?', opts: o4('6000', '600000', '60000', '6000000'), ans: 'B', why: 'Chữ số 6 ở hàng trăm nghìn nên có giá trị 600000.' },
    ...
    { sec: 'Đơn vị đo', name: 'Câu 8', pts: 1, text: '5000 g = ? kg', opts: o4('50 kg', '500 kg', '5 kg', '5000 kg'), ans: 'C', why: '1 kg = 1000 g nên 5000 g = 5 kg.' },
...
/* ═══════════ ĐỀ 27 — ÔN TẬP TỔNG HỢP (3) ═══════════ */
{
  ...
  questions: [
    { sec: 'Làm tròn', name: 'Câu 1', pts: 1, text: 'Làm tròn số 384726 đến hàng nghìn được số nào?', opts: o4('384000', '385000', '390000', '380000'), ans: 'B', why: 'Chữ số hàng trăm là 7 (≥ 5) nên làm tròn lên: 385000.' },
    ...
    { sec: 'Đơn vị đo', name: 'Câu 4', pts: 1, text: '2 kg 500 g = ? g', opts: o4('2500 g', '250 g', '2050 g', '25000 g'), ans: 'A', why: '2 kg = 2000 g, cộng 500 g → 2500 g.' },
    ...
    { sec: 'Số học', name: 'Câu 8', pts: 1, text: 'Số bé nhất có bốn chữ số khác nhau là số nào?', opts: o4('1000', '1234', '1023', '1002'), ans: 'C', why: 'Chọn nhỏ nhất: hàng nghìn 1, rồi 0, 2, 3 khác nhau → 1023.' },
    { sec: 'Đơn vị đo', name: 'Câu 9', pts: 1, text: '3000 kg = ? tấn', opts: o4('30 tấn', '300 tấn', '3 tạ', '3 tấn'), ans: 'D', why: '1 tấn = 1000 kg nên 3000 kg = 3 tấn.' },
...
/* ═══════════ ĐỀ 28 — SỐ & GIÁ TRỊ CHỮ SỐ (NÂNG CAO) ═══════════ */
{
  ...
  questions: [
    { sec: 'Viết số', name: 'Câu 1', pts: 1, text: 'Số gồm 5 triệu, 4 trăm nghìn, 3 chục và 2 đơn vị viết là số nào?', opts: o4('5400320', '5400032', '5043002', '5400302'), ans: 'B', why: '5 triệu = 5000000, 4 trăm nghìn = 400000, 3 chục = 30, 2 đơn vị = 2 → 5400032.' },
    { sec: 'Làm tròn', name: 'Câu 2', pts: 1, text: 'Làm tròn số 45678 đến hàng chục nghìn được số nào?', opts: o4('50000', '40000', '45000', '46000'), ans: 'A', why: 'Chữ số hàng nghìn là 5 (≥ 5) nên làm tròn lên: 50000.' },
    { sec: 'Giá trị chữ số', name: 'Câu 3', pts: 1, text: 'Giá trị của chữ số 3 trong số 7235618 là bao nhiêu?', opts: o4('3000', '300000', '30000', '3000000'), ans: 'C', why: 'Từ phải sang: 3 ở hàng chục nghìn nên có giá trị 30000.' },
    { sec: 'Số chẵn', name: 'Câu 4', pts: 1, text: 'Số chẵn bé nhất có 5 chữ số khác nhau là số nào?', opts: o4('10234', '10000', '12340', '10236'), ans: 'A', why: 'Chọn nhỏ nhất, các chữ số khác nhau, tận cùng chẵn: 10234.' },
    ...
    { sec: 'Số liền sau', name: 'Câu 6', pts: 1, text: 'Số liền sau của số lớn nhất có 6 chữ số là số nào?', opts: o4('999998', '1000000', '1000001', '100000'), ans: 'B', why: 'Số lớn nhất có 6 chữ số là 999999; liền sau là 1000000.' },
    { sec: 'Đếm chữ số', name: 'Câu 7', pts: 1, text: 'Số 2020202 có mấy chữ số 2?', opts: o4('4', '3', '5', '2'), ans: 'A', why: 'Các chữ số: 2, 0, 2, 0, 2, 0, 2 — có 4 chữ số 2.' },
    { sec: 'So sánh đơn vị', name: 'Câu 8', pts: 1, text: 'So sánh 5 tấn và 4900 kg:', opts: o4('5 tấn < 4900 kg', '5 tấn = 4900 kg', '5 tấn > 4900 kg', 'Không so sánh được'), ans: 'C', why: '5 tấn = 5000 kg, mà 5000 > 4900 nên 5 tấn > 4900 kg.' },
    { sec: 'Tổng chữ số', name: 'Câu 9', pts: 1, text: 'Tổng các chữ số của số 999 là bao nhiêu?', opts: o4('18', '9', '999', '27'), ans: 'D', why: '9 + 9 + 9 = 27.' },
    { sec: 'Số tròn nghìn', name: 'Câu 10', pts: 1, text: 'Số nào dưới đây là số tròn nghìn?', opts: o4('5000', '5500', '5050', '5005'), ans: 'A', why: 'Số tròn nghìn có ba chữ số tận cùng là 000 → 5000.' },
  ],
},
...
/* ═══════════ ĐỀ 29 — TÍNH NHANH & PHỐI HỢP PHÉP TÍNH ═══════════ */
{
  ...
  questions: [
    { sec: 'Tính nhanh', name: 'Câu 1', pts: 1, text: '4 × 25 × 13 = ?', opts: o4('1200', '1300', '130', '1250'), ans: 'B', why: '4 × 25 = 100, rồi 100 × 13 = 1300.' },
    { sec: 'Tính nhanh', name: 'Câu 2', pts: 1, text: '2 × 5 × 8 × 5 = ?', opts: o4('400', '200', '800', '80'), ans: 'A', why: '2 × 5 = 10, 10 × 8 = 80, 80 × 5 = 400.' },
    { sec: 'Tính nhanh', name: 'Câu 3', pts: 1, text: '125 × 8 × 3 = ?', opts: o4('1000', '375', '3000', '3375'), ans: 'C', why: '125 × 8 = 1000, rồi 1000 × 3 = 3000.' },
    ...
    { sec: 'Trừ liên tiếp', name: 'Câu 10', pts: 1, text: '1000 − 1 − 2 − 3 = ?', opts: o4('994', '996', '1006', '990'), ans: 'A', why: '1000 − (1 + 2 + 3) = 1000 − 6 = 994.' },
  ],
},
...
/* ═══════════ ĐỀ 30 — TỔNG HỢP CUỐI ═══════════ */
{
  ...
  questions: [
    { sec: 'Đọc số', name: 'Câu 1', pts: 1, text: 'Số 405000000 đọc là:', opts: o4('Bốn trăm năm triệu', 'Bốn trăm linh năm triệu', 'Bốn trăm linh năm nghìn', 'Bốn mươi lăm triệu'), ans: 'B', why: '405000000 đọc là "bốn trăm linh năm triệu".' },
    { sec: 'Trừ', name: 'Câu 2', pts: 1, text: '12345 − 6789 = ?', opts: o4('5556', '5656', '5546', '6556'), ans: 'A', why: '12345 − 6789 = 5556.' },
    ...
    { sec: 'Đơn vị đo', name: 'Câu 7', pts: 1, text: '4 tấn 5 tạ = ? kg', opts: o4('4500 kg', '4050 kg', '450 kg', '45000 kg'), ans: 'A', why: '4 tấn = 4000 kg, 5 tạ = 500 kg → 4500 kg.' },
